package tv.danmaku.ijk.media.example.entities;
...
public interface MUrlInterface {
    ...
    // 视频
    public final static String URL_VIDEO1 = "http://devimages.apple.com.edgekey.net/streaming/examples/bipbop_4x3/bipbop_4x3_variant.m3u8";
